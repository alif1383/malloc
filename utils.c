...
void vmFooter(struct block_header *block){
size_t blockSize = BLKSZ(block);
struct block_footer *footer = (struct block_footer *)((char *)block + blockSize - sizeof(struct block_footer));
printf("blcok Size: %zu", blockSize);
